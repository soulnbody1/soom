...
Route::middleware(['auth:sanctum', 'role:admin,user'])->prefix('soom')->group(function () {
    ...
    Route::get('/account/shell', AccountShellController::class)->middleware('account_global');
    Route::get('/account/dashboard-summary', AccountDashboardSummaryController::class)->middleware('account_global');
    ...
    Route::prefix('ads')->group(function () {
        ...
        Route::get('/my', [MyAdController::class, 'index'])->middleware('account_global');
    ...
    Route::prefix('favorites')->group(function () {
        Route::get('/', [FavoriteController::class, 'index'])->middleware('account_global');
        Route::post('/', [FavoriteController::class, 'store'])->middleware('throttle:ads-engagement');
        Route::delete('/{ad}', [FavoriteController::class, 'destroy'])->whereUlid('ad')
            ->middleware(['account_global', 'throttle:ads-engagement']);
    });
    ...
    Route::prefix('messages')->group(function () {
        ...
        Route::get('/chat/{userId}', [ConversationController::class, 'show'])
            ->whereNumber('userId')->middleware(['account_global', 'throttle:chat-read']);
        Route::get('/conversations', [ConversationController::class, 'index'])->middleware(['account_global', 'throttle:chat-read']);
