...
return [
    ...
    'errors' => [
        ...
        'payment_fee_tier_missing' => 'No configured fee tier covers this payment amount.',
        'payment_fee_schedule_invalid' => 'The configured customer fee schedule is not valid.',
        'payment_bill_query_invalid' => 'The bill lookup request could not be read.',
        'payment_bill_query_payload_too_large' => 'The bill lookup payload is too large.',
        'payment_provider_bill_presentment_unsupported' => 'This payment provider does not present bills.',
        'payment_billing_reference_unavailable' => 'A billing reference could not be allocated. Please try again.',
        'payment_bill_reference_unavailable' => 'A bill reference could not be allocated. Please try again.',
    ...
    'bill_results' => [
        ...
        'unmatched' => 'Bill not recognised by the biller',
        'unknown_billing_reference' => 'Unknown billing number',
        'no_payable_bills' => 'No outstanding bill found',
        'bill_not_found' => 'Bill not found',
        'bill_not_payable' => 'Bill is not payable',
        'bill_already_paid' => 'Bill has been paid previously',
    ],
];
